...
project = 'pywear'
copyright = '2021, Actigraph LLC'
author = 'Actigraph Developers'
...
html_theme_options = {
    ...
    'navbar_links': [
        ...
        ("API", "api"),
        ("GitHub", "https://github.com/actigraph/pywear", True)
    ],
...
latex_documents = [
    (master_doc, 'pywear.tex', 'pywear Documentation',
     'Sheraz Khan', 'manual'),
]
...
man_pages = [
    (master_doc, 'pywear', 'pywear Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pywear', 'pywear Documentation',
     author, 'pywear', 'One line description of project.',
     'Miscellaneous'),
]
